...
### iOS (애플 앱스토어)  
- **번들 ID**: com.monk.beumz
- **앱명**: 비움

## 📋 앱스토어 등록 추가 정보

### 지원 URL (Support URL) - 필수
**권장 URL**: `https://username.github.io/beumz-support` 또는 개인 웹사이트

**지원 페이지에 포함할 내용:**
- ✅ 앱 소개 및 주요 기능 설명
- ✅ 사용법 가이드 (습관 추가, 감정 기록, 통계 확인)
- ✅ 자주 묻는 질문 (FAQ)
- ✅ 문의/연락처 정보
- ✅ 개인정보 처리방침 (로컬 저장, 개인정보 미수집)
- ✅ 서비스 이용약관
- ✅ 업데이트 정보
- ✅ 버그 신고 및 피드백 방법
...
### SKU (Stock Keeping Unit) - 필수
**권장값**: `BEUMZ_HABIT_TRACKER_IOS` 또는 `com.monk.beumz.ios`
- 개발자 계정 내에서 고유한 식별자
- 한 번 설정하면 변경 불가
- 사용자에게는 보이지 않음
